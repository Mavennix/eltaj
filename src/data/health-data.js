...
const HealthData = [
    {
        title: '',
        image: Doctor,
        subTitle: 'Just like in every industry, patients now seek to be treated as customers and receive the best healthcare service. With ELTAJ’s Patient experience solution, including customer feedback, queue management system, Business intelligence - your hospital, lab, clinic can create a seamless customer experience to provide hassle free-care for patients while reducing staff stress-level.',
        features: [
            '49% - Customer that say healthcare experience is satisfactory',
            '94% - Healthcare executives plan to implement smart technologies.',
            '88%- Healthcare executives admit having insufficient patient information hinders them from meeting expectations.',
        ]
    },
    {
        title: 'Ensure patients’ safety on queue',
        subTitle: 'With the advent of COVID-19, hospitals now have to stay on their heels to ensure there is social distancing between patients to reduce the spread of the virus. But it doesn’t have to be difficult. With the ELTAJ smart solutions',
        features: [
            'Patients find preferred branches online and schedule an appointment before walking into the hospital',
            'On arrival, patients use the Qmatic solo to check-in and queue remotely.',
    ...
    },
    {
        ...
        image: NowServing,
        subTitle: 'Take advantage of patients’ visits. With the qmatic digital signage solution you can inform patients about their queue status and provide helpful health information to keep them sensitized.',
        features: [
