            ...
            <div className="col-md-6 my-auto pb-md-0 pb-5">
              <div className="row">
                <div className="col-md-10">
                  <h1 className="mb-4">SELF SERVICE KIOSK</h1>
            ...
            <Row>
              <div className="col-md-10 mx-auto">
                <h4 className="text-capitalize">
                  When customers control how they interact with your business,
                  you can do no wrong serving them.
                </h4>
              </div>
            </Row>
            <Row>
              <div className="col-md-9 mx-auto">
                <p className="text-muted mt-3">
                  You would agree that we all love to get the best service,
                  anytime and wherever we want it. With evolving technology,
                  customers can get the service they want with utmost
                  convenience. With ELTAJ’s digital kiosks installed in your
                  branches, customers can access your services without having to
                  interact with your staff, reducing congestion and, in turn,
