        ...
        <Layout>
                        ...
                        <div className="col-md-6 my-auto pb-md-0 pb-5">
                            <div className="row">
                                <div className="col-md-10">
                                    <h1 className="mb-4">
                                        Qmatic Enterprise Orchestra 7
                    </h1>
                                    <h6 className="text-muted">
                                        A robust solution for queue management and customer journey management
                    </h6>
                                </div>
                            </div>
                    ...
                    <div className="text-center">
                        <Row>
                            <div className="col-md-10 mx-auto">
                                <h4 className="text-capitalize">CREATE A SEAMLESS COMMUNICATION AT EVERY TOUCHPOINT</h4>
                            </div>
                        </Row>
                        <Row>
                            <div className="col-md-9 mx-auto">
                                <p className="text-muted mt-3">How do you communicate with customers when they visit your branches? The enterprise Orchestra 7 empowers you to communicate with customers pre-arrival to post serving.</p>
                            </div>
                        </Row>
                        ...
                        {QmaticFeatures.map((feature, index) => (
                            <div className="col-lg-3">
                                <div className="d-flex h-100">
                                    <AssetInfoBox title={feature.title} subtitle={feature.subTitle} image={feature.icon} />
                                </div>
                            </div>
                        ))}
                    </Row>
            ...
            <section className="pt-5 mt-5">
                <Container>
                    <div className="text-center">
                        <Row>
                            <div className="col-md-10 mx-auto">
                                <h4 className="text-capitalize">DID WE MEET CUSTOMER EXPECTATION? CAPTURE THE FEEDBACK</h4>
                            </div>
                        </Row>
                        <Row>
                            <div className="col-md-9 mx-auto">
                                <p className="text-muted mt-3">With the Omni channel customer feedback, you give customers multiple channels to tell you how they feel about your service at each touch point and collect the data.</p>
                            </div>
                        </Row>
                    </div>
            ...
            <section className="container my-5 pt-5">
                <InfoSection textFirst={true} image={BookingTabImg}>
                    <h2 className="mb-4">
                        EMPOWER EMPLOYEES TO WORK EFFICIENTLY
            </h2>

                    <h6 className="text-muted">Part of creating customer experience is to enable your employees to work more efficiently. With the orchestra workstation terminal, your employees can have the best experience serving customers</h6>
                    <div>
            ...
            <section>
                <Container>
                    <div className="text-center">
                        <Row>
                            <div className="col-md-10 mx-auto">
                                <h4 className="text-capitalize">Make Informed decisions with business intelligence</h4>
                            </div>
                        </Row>
                        <Row>
                            <div className="col-md-9 mx-auto">
                                <p className="text-muted mt-3">The Qmatic orchestra Business Intelligence integration optimizes your wholesome business data , providing you with actionable insights at a glance.</p>
                            </div>
                        </Row>
                    </div>
                    <Row className="mt-5">
