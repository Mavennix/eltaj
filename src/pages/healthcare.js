...
import HeroImg from "../images/industries/health.png"
                        ...
                        <div className="col-md-6 my-auto pb-md-0 pb-5">
                            <div className="row">
                                <div className="col-md-10">
                                    <div className="mb-3">
                                        <LightTitleBox text="HealthCare" />
                                    </div>
                                    <h1 className="mb-4">
                                    Transform your HOSPITALS into smart digital branches
                    </h1>
                                    <h6 className="text-muted">
                                    Deliver a hassle-free experience for patient with smart digital healthcare facility
                    </h6>
                                </div>
                            </div>
