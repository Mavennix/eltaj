                    ...
                    <div className="text-center">
                        <Row>
                            <div className="col-md-10 mx-auto">
                                <h4 className="text-capitalize">Reduce customer wait time with the powerful queue management platform</h4>
                            </div>
                        </Row>
                        <Row>
                            <div className="col-md-9 mx-auto">
                                <p className="text-muted mt-3">The single location Solo platform, when deployed on-premise allows you to manage customer flow on queue, streamline their customer journey and maintain social distancing rules while at it.</p>
                            </div>
                        </Row>
                    </div>
