            ...
            <div className="col-md-6 my-auto pb-md-0 pb-5">
              <div className="row">
                <div className="col-md-10">
                  <h1 className="mb-4">DIGITAL SIGNAGE</h1>
                  <h6 className="text-muted">Display content with context</h6>
                </div>
              </div>
              <BookDemoBtn/>
            ...
            <Row>
              <div className="col-md-10 mx-auto">
                <h4 className="text-capitalize">
                  Personalise customers’ experience with the right content.
                </h4>
              </div>
            </Row>
            <Row>
              <div className="col-md-9 mx-auto">
                <p className="text-muted mt-3">
                  Every minute a customer spends interacting with your business
                  is an opportunity to keep them delighted. Inform, educate and
                  engage them with the right content to keep them coming back
                  for more .
                </p>

                <p className="text-muted mt-3">
                  The ELTAJ digital solution allows you to inform customers of
                  queue status, educate them with valuable content and promote
