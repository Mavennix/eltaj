  ...
  return (
    <Layout>
      ...
      <Container className="my-5 py-4">
        <div className="row">
          <div className="col-md-5 mh-100 offset-md-1 mb-md-0 mb-4">
           ...
           <CardWithBoxShadow className="h-100">
              ...
              <p className="text-muted pt-3 small">
                ...
                innovating world-class technology solutions that create great
                experiences for customers, patients, citizens and the staff who
                serve them.
              </p>
            </CardWithBoxShadow>
           </div>
          ...
          <div className="col-md-5 mh-100">
            ...
            <CardWithBoxShadow className="h-100">
             ...
             <img
              ...
              <p className="text-muted pt-3 small">
                Veryday is an international company providing Customer
                Experience services and solutions. Established in Sweden 45
                years ago, Veryday has several offices operating in Dubai,
                Riyadh, New York and Shanghai.
              </p>
             </div>
            </CardWithBoxShadow>
            </div>
